...
--
-- Host: 127.0.0.1
-- Generation Time: 2017-01-17 15:59:58
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
CREATE TABLE IF NOT EXISTS `es_bindings` (
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='系统 - 绑定菜单' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `es_cloud` (
...
CREATE TABLE IF NOT EXISTS `es_core_paylog` (
  ...
  KEY `VIDX_TID` (`tid`),
  KEY `VIDX_ALID` (`alid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='系统 - 支付记录' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `es_fans` (
  ...
  KEY `VIDX_ALID` (`alid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统 - 用户(粉丝)库' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `es_functions` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `setting` text,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='系统 - 功能列表' AUTO_INCREMENT=7 ;

--
-- 转存表中的数据 `es_functions`
--

INSERT INTO `es_functions` (`id`, `title`, `title_en`, `version`, `ability`, `content`, `author`, `url`, `icon`, `status`, `inorder`, `default`, `cloud`, `oauth`, `reply`, `point`, `setting`) VALUES
(1, '自定义菜单', 'menu', '1.0', NULL, NULL, '微窗', 'http://www.vwins.cn', NULL, '使用中', 0, 1, 0, 0, 0, -1, NULL),
(2, '自动回复', 'reply', '1.0', NULL, NULL, '微窗', 'http://www.vwins.cn', NULL, '使用中', 0, 1, 0, 0, 0, -1, NULL),
(3, '消息管理', 'message', '1.0', NULL, NULL, '微窗', 'http://www.vwins.cn', NULL, '使用中', 0, 1, 0, 0, 0, -1, NULL),
(4, '素材库', 'library', '1.0', NULL, NULL, '微窗', 'http://www.vwins.cn', NULL, '使用中', 0, 1, 0, 0, 0, -1, NULL),
(5, '会员卡', 'vip', '1.0', NULL, NULL, '微窗', 'http://www.vwins.cn', NULL, '使用中', 0, 1, 0, 1, 0, -1, NULL),
(6, '模拟测试', 'emulator', '1.0', NULL, NULL, '微窗', 'http://www.vwins.cn', NULL, '使用中', 0, 1, 0, 0, 0, -1, NULL);
...
CREATE TABLE IF NOT EXISTS `es_information` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(255) DEFAULT NULL,
  `content` text,
  `indate` bigint(18) unsigned DEFAULT '0',
  ...
  `inorder` int(10) unsigned DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='系统 - 公告' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `es_library` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `alid` int(10) unsigned DEFAULT '0',
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统 - 素材库' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `es_linkage` (
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='系统 - 联动省市区' AUTO_INCREMENT=3360 ;

--
-- 转存表中的数据 `es_linkage`
--

INSERT INTO `es_linkage` (`id`, `name`, `style`, `parentid`, `child`, `arrchildid`, `keyid`, `listorder`, `description`, `setting`, `siteid`) VALUES
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='系统 - 信息记录、信息回复' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `es_pay` (
  `title` varchar(255) DEFAULT NULL,
...
INSERT INTO `es_pay` (`title`, `value`, `content`, `view`) VALUES
...
CREATE TABLE IF NOT EXISTS `es_pay_order` (
  ...
  `indate` bigint(18) unsigned DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='系统 - 支付订单记录' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `es_question` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` text,
  `content` text,
  `indate` bigint(18) unsigned DEFAULT '0',
  ...
  `inorder` int(10) unsigned DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='系统 - 常见问题' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `es_reply` (
  ...
  `inorder` int(10) unsigned DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统 - 自动回复' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `es_setting` (
...
CREATE TABLE IF NOT EXISTS `es_tmp` (
...
CREATE TABLE IF NOT EXISTS `es_users` (
  ...
  `regsetting` text,
  PRIMARY KEY (`userid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='系统 - 客户列表' AUTO_INCREMENT=2 ;

--
-- 转存表中的数据 `es_users`
--

INSERT INTO `es_users` (`userid`, `admin`, `username`, `encrypt`, `userpass`, `fullname`, `phone`, `email`, `qqnum`, `companyname`, `tel`, `linkaddr`, `address`, `point`, `sms`, `indate`, `enddate`, `inip`, `loginip`, `logindate`, `regsetting`) VALUES
(1, 1, 'admin', 'Kd6tlE', '164deeba6add09737521432c86c3ddb4', 'admin', NULL, 'admin@admin.com', NULL, 'admin', NULL, NULL, NULL, 0, 0, 0, 0, NULL, NULL, 0, NULL);
...
CREATE TABLE IF NOT EXISTS `es_users_al` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `userid` int(10) unsigned DEFAULT '0',
  `username` varchar(50) DEFAULT NULL,
  `companyname` varchar(50) DEFAULT NULL,
  ...
  `payment` text,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='系统 - 服务窗(公众号)列表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `es_users_functions`
--

CREATE TABLE IF NOT EXISTS `es_users_functions` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `userid` int(10) unsigned DEFAULT '0',
  ...
  `userdata` mediumtext,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='系统 - 客户已开通的功能' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `es_users_point` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userid` int(10) unsigned DEFAULT '0',
  ...
  `indate` bigint(18) unsigned DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='系统 - 客户积分记录' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `es_vip_content` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `alid` int(10) unsigned DEFAULT '0',
  ...
  `setting` mediumtext,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='VIP - 通知管理、会员特权、优惠券、礼品券' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `es_vip_content_notes`
--

CREATE TABLE IF NOT EXISTS `es_vip_content_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `alid` int(10) unsigned DEFAULT '0',
  `type` varchar(20) DEFAULT NULL COMMENT '类型',
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='VIP - 使用统计' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `es_vip_pay` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `status` tinyint(1) unsigned DEFAULT '0',
  `type` varchar(20) DEFAULT NULL,
  `userid` int(10) unsigned DEFAULT '0',
  ...
  `indate` bigint(18) unsigned DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='VIP - 充值记录' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `es_vip_point_notes`
--

CREATE TABLE IF NOT EXISTS `es_vip_point_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `alid` int(10) unsigned DEFAULT '0',
  `openid` varchar(50) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='VIP - 会员积分详情' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `es_vip_record` (
  `id` bigint(18) unsigned NOT NULL AUTO_INCREMENT,
  `alid` int(10) unsigned DEFAULT '0',
  `type` varchar(20) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='VIP - 发放统计' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `es_vip_setting` (
  `title` varchar(50) NOT NULL,
  `alid` int(10) unsigned DEFAULT '0',
  `content` text,
  PRIMARY KEY (`title`)
...
CREATE TABLE IF NOT EXISTS `es_vip_shop` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `alid` int(10) unsigned DEFAULT '0',
  `type` varchar(20) DEFAULT NULL COMMENT '类型',
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='VIP - 店铺、分店' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `es_vip_shop_users`
--

CREATE TABLE IF NOT EXISTS `es_vip_shop_users` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `alid` int(10) unsigned DEFAULT '0',
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='VIP - 店员' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `es_vip_users` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `type` varchar(10) DEFAULT NULL,
  `alid` int(10) unsigned DEFAULT '0',
  ...
  KEY `VIDX_OPENID` (`openid`),
  KEY `VIDX_ALID` (`alid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='VIP - 会员' AUTO_INCREMENT=1 ;
